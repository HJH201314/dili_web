...
type DiliPaginationProps = {
  pageCount: number; // 总页数
  currentPage?: number; // 当前页码
}

const props = withDefaults(defineProps<DiliPaginationProps>(), {
});
...
<template>
  <div class="dili-pagination">
    ...
    <div v-for="i in pageNums" :class="{'active': currentPage == i}" @click="handleChangePage(i)">
      <span>{{ i }}</span>
    </div>
